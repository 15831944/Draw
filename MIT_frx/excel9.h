...
public:
	...
	VARIANT AutoFit();
	VARIANT AutoFormat(long Format, const VARIANT& Number, const VARIANT& ExcelFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width);
	VARIANT AutoOutline();
...
class XlPageSetup : public COleDispatchDriver
{
public:
	XlPageSetup() {}		// Calls COleDispatchDriver default constructor
	XlPageSetup(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	XlPageSetup(const XlPageSetup& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
