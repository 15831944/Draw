...
IMPLEMENT_DYNCREATE(MAutoHideButton, CBCGPAutoHideButton)

//**********************************************************************************//
CSize MAutoHideButton::GetSize (BOOL bIgnoreOthersInRow) const
{
	return CBCGPAutoHideButton::GetSize(bIgnoreOthersInRow);
}

//**********************************************************************************//
BOOL MAutoHideButton::Create (CBCGPAutoHideToolBar* pParentBar, 
...
//**********************************************************************************//
void MAutoHideButton::OnDraw (CDC* pDC)
{
	ASSERT_VALID (this);
