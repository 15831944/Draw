...
namespace mit
{
	namespace frx
	{
		...
		class __MY_EXT_CLASS__ MLayeredMiniFrameWnd : public CBCGPMiniFrameWnd, MFadeEffectCtrl
		{
			friend class MVisualManager2007;

			DECLARE_SERIAL(MLayeredMiniFrameWnd)

		public:
			MLayeredMiniFrameWnd(void);
			virtual ~MLayeredMiniFrameWnd(void);
