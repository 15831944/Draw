...
// Leaving in place for standard windows functions not using MFC.
...
class FOUNDATION_API CGDIBitmap : 
...
class FOUNDATION_API CGDIBrush : 
...
class FOUNDATION_API CGDIFont :	public CGDIObject<HFONT>
{
public:
			 ...
			 LPCTSTR lpszFacename)
{
	...
	#ifdef _WIN64
		_tcsncpy(lf.lfFaceName, lpszFacename, _SFLMIN(31u, (UINT)_tcslen(lpszFacename)));
	#else
		_tcsncpy(lf.lfFaceName, lpszFacename, _SFLMIN(31u, (UINT)_tcslen(lpszFacename)));
	#endif //_WIN64
#else // if NONSTANDARD_GDI
	wcsncpy(lf.lfFaceName, lpszFacename, _SFLMIN(31, (int)wcslen(lpszFacename)));
#endif //NONSTANDARD_GDI
...
class FOUNDATION_API CGDIPalette: 
