...
//
//
struct FOUNDATION_API  _OTL_DATACACHE_ENTRY
{
...
class FOUNDATION_API _EnumFORMATETCImpl : public IEnumFORMATETC
{
	bool m_bIsClone;
	ULONG m_nNdx;
	LONG m_cRef;
...
public:
	...
	STDMETHODIMP Skip(ULONG celt)
	{
		...
		ULONG nSize = (ULONG)m_pFormatETCCache->size();
...
//
class FOUNDATION_API CDataObject : public IDataObject
{
// State
protected:
...
// static utilities
	...
	static HGLOBAL _CopyGlobalMemory(HGLOBAL hDest, HGLOBAL hSource)
	{
		...
		size_t nSize = ::GlobalSize(hSource);
		if (hDest == NULL)
		{
