...
class __declspec(uuid("5EE9EAE4-67B2-11d3-9D9C-00C04F91E286"))
	 CBorderEdge
...
//@base public | CBorderGraphic<CGripperWrapper, IBorderLayout>
//@supint ILayoutNode | Basic layout node functionality.
//@supint IBorderLayout | Additional functionality for border nodes.
class __declspec(uuid("5EE9EAE0-67B2-11d3-9D9C-00C04F91E286"))
	 CGripperWrapper
