...
interface __declspec(uuid("8B1647C0-45E5-11d3-9D92-00C04F91E286")) ILayoutNode:
	public IQueryGuid
{
	...
	// A CLayoutTransaction structure contains information that needs to be shared among all
