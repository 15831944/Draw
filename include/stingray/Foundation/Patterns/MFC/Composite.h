...
public:
	...
	virtual SEC_INT GetChildCount(BOOL bRecursive=FALSE) const;
...
public:
	...
	// NOT IMPLEMENTED:
	virtual SEC_INT GetSize() const 						{ ASSERT(FALSE); return -1; }
...
// Return number of children in composite
template <class element_t>
SEC_INT SECComposite_T<element_t>::GetChildCount(BOOL bRecursive) const {
	// get count of immediate children
	SEC_INT nChildCount=m_listChildren.GetCount();
