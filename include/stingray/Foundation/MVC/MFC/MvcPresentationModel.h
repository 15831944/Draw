...
class MvcPresentationModel_T :  public viscomp_t,
				public CMvcModel,
...
template<class viscomp_t>
CMvcCommand* MvcPresentationModel_T<viscomp_t>::PeekUndo(int nIndex)
{
	ASSERT(m_pTransModel != NULL);
	return m_pTransModel->PeekUndo(nIndex);
}

//@doc MvcPresentationModel_T
//@mfunc Get the Redo command with specified index
//@rdesc CMvcCommand* A pointer to the command with specified index
template<class viscomp_t>
CMvcCommand* MvcPresentationModel_T<viscomp_t>::PeekRedo(int nIndex)
{
	ASSERT(m_pTransModel != NULL);
	return m_pTransModel->PeekRedo(nIndex);
}
...
template<class viscomp_t>
CMvcCommand* MvcPresentationModel_T<viscomp_t>::PopUndo()
{
	ASSERT(m_pTransModel != NULL);
	return m_pTransModel->PopUndo();
}
//@doc MvcPresentationModel_T
//@mfunc Pop the Redo command from stack
//@rdesc CMvcCommand* A pointer to the command 
template<class viscomp_t>
CMvcCommand* MvcPresentationModel_T<viscomp_t>::PopRedo()
{
                 ASSERT(m_pTransModel != NULL);
	return m_pTransModel->PopRedo();
}
//@doc MvcPresentationModel_T
...
//@rdesc void
template<class viscomp_t>
void MvcPresentationModel_T<viscomp_t>::PushUndo(MvcCommand* pCmd)
{
                  ASSERT(m_pTransModel != NULL);
	 m_pTransModel->PushUndo(pCmd);
}
//@doc MvcPresentationModel_T
...
//@rdesc void
template<class viscomp_t>
void MvcPresentationModel_T<viscomp_t>::PushRedo(MvcCommand* pCmd)
{
	ASSERT(m_pTransModel != NULL);
	 m_pTransModel->PushRedo(pCmd);
}
...
//@rdesc Undo commands count
template<class viscomp_t>
int MvcPresentationModel_T<viscomp_t>::GetUndoCommandsCount() const
{
	ASSERT(m_pTransModel != NULL);
	return m_pTransModel->GetUndoCommandsCount();
}

//@doc MvcPresentationModel_T
//@mfunc Get the Redo commands count
//@rdesc Redo commands count
template<class viscomp_t>
int MvcPresentationModel_T<viscomp_t>::GetRedoCommandsCount() const
{
	ASSERT(m_pTransModel != NULL);
	return m_pTransModel->GetRedoCommandsCount();
}
