...
#ifdef HAVE_UNSIGNED_CHAR
typedef unsigned char JSECUINT8;
#else /* not HAVE_UNSIGNED_CHAR */
#ifdef CHAR_IS_UNSIGNED
typedef char JSECUINT8;
#else /* not CHAR_IS_UNSIGNED */
typedef short JSECUINT8;
#endif /* CHAR_IS_UNSIGNED */
#endif /* HAVE_UNSIGNED_CHAR */
...
#ifdef HAVE_UNSIGNED_SHORT
typedef unsigned short JSECUINT16;
#else /* not HAVE_UNSIGNED_SHORT */
typedef unsigned int JSECUINT16;
#endif /* HAVE_UNSIGNED_SHORT */

/* INT16 must hold at least the values -32768..32767. */

typedef short JSECINT16;

/* INT32 must hold signed 32-bit values; if your machine happens */
/* to have 64-bit longs, you might want to change this. */

typedef long JSECINT32;

};  // namespace stingray::foundation
};  // namespace stingray

#endif __SFL_JCONFIG_H__
