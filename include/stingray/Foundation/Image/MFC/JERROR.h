...
#define SEC_ERREXIT(cinfo,code)  \
  ((cinfo)->err->msg_code = (code), \
   (this->*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)))
#define SEC_ERREXIT1(cinfo,code,p1)  \
  ((cinfo)->err->msg_code = (code), \
   (cinfo)->err->msg_parm.i[0] = (p1), \
   (this->*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)))
#define SEC_ERREXIT2(cinfo,code,p1,p2)  \
  ((cinfo)->err->msg_code = (code), \
   (cinfo)->err->msg_parm.i[0] = (p1), \
   (cinfo)->err->msg_parm.i[1] = (p2), \
   (this->*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)))
#define SEC_ERREXIT3(cinfo,code,p1,p2,p3)  \
  ((cinfo)->err->msg_code = (code), \
   (cinfo)->err->msg_parm.i[0] = (p1), \
   (cinfo)->err->msg_parm.i[1] = (p2), \
   (cinfo)->err->msg_parm.i[2] = (p3), \
   (this->*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)))
#define SEC_ERREXIT4(cinfo,code,p1,p2,p3,p4)  \
  ((cinfo)->err->msg_code = (code), \
   (cinfo)->err->msg_parm.i[0] = (p1), \
   (cinfo)->err->msg_parm.i[1] = (p2), \
   (cinfo)->err->msg_parm.i[2] = (p3), \
...
#define SEC_ERREXITS(cinfo,code,str)  \
  ((cinfo)->err->msg_code = (code), \
