...
#else
	#pragma message("Warning:  The colorwell control was not included in the Stingray Foundation Library.")
	#pragma message("          Add this component to the library using the BuildWizard and rebuild Stingray Foundation Library.")
