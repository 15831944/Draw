...
#if !defined(AFX_SECIEXTRACTICONIMPL_H__4B3535F2_E46C_4DAE_8707_321EB0D1D9F3__INCLUDED_)
#define AFX_SECIEXTRACTICONIMPL_H__4B3535F2_E46C_4DAE_8707_321EB0D1D9F3__INCLUDED_
...
/////////////////////////////
// AutoDuck tag block block for SECIExtractIconImpl 

//@doc SECIExtractIconImpl
//@mdata HWND      | SECIExtractIconImpl | m_hwndOwner | A window handle to the owner of this interface.

//@doc SECIExtractIconImpl
//@mdata LPITEMIDLIST    | SECIExtractIconImpl | m_pPidl | A copy of the PIDL the instance of this class is attached to.

//@doc SECIExtractIconImpl
//@mdata TPidlMgr*     | SECIExtractIconImpl | m_pPidlMgr | A PIDL manager to help manage the PIDL.

//SECIExtractIconImpl<class TPidlMgr>
//@mfunc | SECIExtractIconImpl | SECIExtractIconImpl | Constructor. It creates a valid instance of PIDL manager class indicated in our template arguments. 
...
//@xref <c SECIExtractIconImpl>

// adinsert AutoDuck insertion point for SECIExtractIconImpl 

//@doc SECIExtractIconImpl 
//@class SECExtractIconImpl 
//@comm This class is a thin wrapper class of IExtractIcon interface. It only implemented the
...
//targeted for namespace or shell extension. Even though this class can be used without 
//deriviation, the default implementation in general will not suit user's need. So To use this class, 
//you need to derive from it and provide sensible implementation for all the methods of IExtractIcon
//other than that of IUnknown interface. The constructor need two arguments, a window handle 
...
public:
	//@cmember
	/* Constructor */
	inline SECIExtractIconImpl(HWND hwndOwner, LPCITEMIDLIST pidl)
	{
	...
	//IExtractIcon
	inline STDMETHOD(GetIconLocation)(UINT /*uFlags*/, LPTSTR /*szIconFile*/, UINT /*cchMax*/,
	...
	inline STDMETHOD (Extract)(LPCTSTR /*pszFile*/, UINT /*nIconIndex*/,
                        HICON* phiconLarge, HICON* phiconSmall, UINT /*nIconSize*/)
	{
		// Here we return two default icon
		*phiconLarge = LoadIcon(NULL, MAKEINTRESOURCE(IDI_WINLOGO));
		*phiconSmall = LoadIcon(NULL, MAKEINTRESOURCE(IDI_WINLOGO));

		//If we didn't extract icon here, we would have to return S_FALSE.
		return NOERROR;
	}
};

#endif // !defined(AFX_SECIEXTRACTICONIMPL_H__4B3535F2_E46C_4DAE_8707_321EB0D1D9F3__INCLUDED_)
