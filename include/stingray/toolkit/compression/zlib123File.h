...
#ifndef __ZLIB123FILE_H__
#define __ZLIB123FILE_H__

#include "Toolkit\compression\OTILoselessCompression.h"
#include "Toolkit\compression\zlib123.h"
#include "..\..\Src\Toolkit\utility\compression\zlib123\zlib.h"
#include <StingrayExportDefs.h>

class ZLib123File : public OTCompressionFile
{
public:
	TOOLKIT_API ZLib123File();
	TOOLKIT_API virtual ~ZLib123File();
...
private:
	ZLib123Compression m_compression;
	gzFile m_gzFile;
};

#endif //__ZLIB123FILE_H__