...
// 
//  Author:			Rob Oliver
//  Description:	ot_activescript.h - Active script component header
//  Created:		Tue Aug 27 14:08:25 1998
//
//

#ifndef __OTM_ACTIVESCRIPT_H__
#define __OTM_ACTIVESCRIPT_H__
...
// ***********************************************************
		...
		// pull in required docking window components if necessary
		#ifdef OT_BLD_DOCKWIN
			#include <toolkit\ot_dockingwindows.h>
		#endif

		// pull in active script/active host headers
	...
	#else
		#pragma message("Warning:  The active script component was not included in the Objective Toolkit library.")
