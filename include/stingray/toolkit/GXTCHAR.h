...
// gxtchar.h - definitions for generic international text functions
//
...
#if _MSC_VER < 1400  // atof defined in tchar.h as of VC++ 8.0
#ifndef _gxttof
  #ifdef _UNICODE
  	#include <StingrayExportDefs.h>
	// TCHAR.H does not provide macros for atof!
	TOOLKIT_API double AFXAPI _gxwtof(LPCTSTR s);
    #define _gxttof     _gxwtof
  #else
    #define _gxttof     atof
  #endif
#endif
...
// Also, check if sectchar.h is included
#ifndef _SECTCHAR_H_
#define _SECTCHAR_H_
