...
class SECMFCShortcutBarWnd : public SECShortcutBarComp, 
	                           public CMFCEventRouter<SECMFCShortcutBarWnd, CWnd>,
...
public:
	...
	inline SECMFCShortcutBarWnd()	{};		
	inline virtual ~SECMFCShortcutBarWnd()
	{
	...
	inline virtual HWND GetWindowHandle()	{ return this->m_hWnd; }

	//@cmember
	/* Creates a windowed shortcutbar.*/
	inline virtual BOOL Create( CWnd* pWndParent, RECT& rcPos, DWORD dwStyle = WS_CHILD|WS_VISIBLE|SEC_TABBAR_BARCURSOR, UINT nID = 0 )
	{
...
//@xref <c SECShortcutBarComp>
//@xref <c SECMFCShortcutBarWnd>
class SECMFCShortcutBarHosted : public SECShortcutBarComp, 
	                              public CMFCEventRouter<SECMFCShortcutBarHosted> 
{

typedef CMFCEventRouter<SECMFCShortcutBarHosted> routerBase;

public:
	inline SECMFCShortcutBarHosted()	{}
	inline virtual ~SECMFCShortcutBarHosted()	{}
