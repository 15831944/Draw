...
{
	CHART_DECLARE_SERIAL(SRGCandleGraph);
	
//@access Public member functions
public:
	//@cmember Constructor
	CHART_API SRGCandleGraph();

	//@cmember Virtual destructor for this class
	CHART_API virtual ~SRGCandleGraph();
...
protected:
	...
	// XML Formatter for SRGCandleGraph
	friend class SRGCandleGraphFTR;
};
