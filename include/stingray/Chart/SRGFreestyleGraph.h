...
{
	CHART_DECLARE_SERIAL(SRGFreestyleGraph);
...
public:
	...
	//@cmember Constructor
	CHART_API SRGFreestyleGraph();

	//@cmember Virtual destructor for this class
	CHART_API virtual ~SRGFreestyleGraph();
...
protected:
	...
	// XML Formatter for SRGFreestyleGraph
	friend class SRGFreestyleGraphFTR;
