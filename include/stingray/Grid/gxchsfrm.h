...
#ifndef _GX_CH_SFRM_H__
#define _GX_CH_SFRM_H__
...
class CGXWFrame : public CFrameWnd, public CGXFrameAdapter
{
	GRID_DECLARE_DYNCREATE(CGXWFrame)
public:
	GRID_API CGXWFrame();
