...
#pragma warning( push )
#pragma warning( disable : 4244 4267 4097 4616 4100 4561)
...
public:
   ...
   {
      return (bool)(JM_MAKE_BOOL(re_class_map[(size_type)(uchar_type)c] & f));
   }
#endif
...
public:
   ...
   {
      return (bool)JM_MAKE_BOOL(((uchar_type)c < 256) ? (re_unicode_classes[(size_type)(uchar_type)c] & f) : re_iswclass(c, f));
   }
#endif
...
private:
   ...
   void RE_CALL set_first(iterator i, typename size_type pos)
   {
      cow();
