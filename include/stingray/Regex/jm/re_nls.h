...
#pragma warning( push )
#pragma warning( disable : 4018 4284 4146 4800 4805 4290 4786 4561)
...
)
{
   ...
   return false;
#else
   return (bool)(re_class_map[(unsigned char)c] & f);
#endif
}
...
)
{
   ...
   return false;
#else
   return (bool)((c < 256) ? (bool)re_unicode_classes[c] & f : (bool)re_iswclass(c, f));
#endif
}
#endif
