...
#if !defined(__STINGRAYSUPPORTEDPLATFORMS__H__)
#define __STINGRAYSUPPORTEDPLATFORMS__H__
...
#pragma message ("Operating System:")
	...
	// Windows Server 2008
	#if (NTDDI_VERSION >= NTDDI_WS08) && (NTDDI_VERSION <= NTDDI_WS08SP4)
	...
	// Windows Vista SP1 - SP4
		...
		#define _WIN32_WINNT 0x0600
		#define	_WIN32_IE	 0x0700
		#pragma message("    Targeting supported (Windows Vista SP1+)* platform.")
		#pragma message("          WINVER      >= 0x0600")
		#pragma message("         _WIN32_WINNT == 0x0600")
		#pragma message("         _WIN32_IE    == 0x0700")
	// Windows Vista
...
#if defined(_M_IA64)
	#pragma message("    Intel Itanium Processor Family is not supported!")
	//#error
#endif

#if defined(_M_IX86)
	#if defined(_WIN64)
		#pragma message("    x86 OS is supported for 32 Bit only")
	#else
...
#if(_MSC_VER >= 1700) // Microsoft Visual Studio 2008 RTM")
	// This is a supported compiler.
	#pragma message("    Microsoft Visual Studio 2012 (11.0 +)")
#elif(_MSC_VER >= 1500) // Microsoft Visual Studio 2008 RTM")
	// This is a supported compiler.
...
#if defined(_SFLDLL) || defined(_OBJCHART_DLL) || defined(_OBJCHART_UT_DLL) || defined(_SECEDITDLL) || defined(_GXDLL) || defined(_SECDLL) || defined(_OVDLL)
...
#endif // (__STINGRAYSUPPORTEDPLATFORMS__H__)